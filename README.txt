...
This is the readme for DungeonRPG, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. DungeonRPG) > Ok.
...
- To run the project find DungeonRPG.java (which will be in under src/main/java/dungeonrpg) and right click > Run 'DungeonRPG'
